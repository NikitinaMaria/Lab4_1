...
# Drawing 5 trees
screen.blit(pygame.transform.scale(screen_tree, (700, 900)), (50, -140))
screen.blit(pygame.transform.scale(screen_tree, (450, 800)), (-50, 50))
screen.blit(pygame.transform.scale(screen_tree, (450, 400)), (130, 270))
screen.blit(pygame.transform.scale(screen_tree, (400, 500)), (50, 320))
screen.blit(pygame.transform.scale(screen_tree, (400, 500)), (-30, 430))
...
# Drawing 4 unicorns
screen.blit(pygame.transform.scale(screen_unicorn, (500, 680)), (-30, 130))
screen.blit(pygame.transform.scale(screen_unicorn_2, (350, 500)), (400, 170))
screen.blit(pygame.transform.scale(screen_unicorn, (250, 320)), (230, 170))
screen.blit(pygame.transform.scale(screen_unicorn_2, (120, 150)), (500, 280))
